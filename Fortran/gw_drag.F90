...
subroutine gw_init()
  ...
  if (use_gw_oro .or. use_gw_rdg_beta .or. use_gw_rdg_gamma) then
     ...
     call addfld ('UTGWORO_RESID',    (/ 'lev' /), 'A','m s-2', &
          'U tendency - orog. GW drag from rdg-resid')
     call addfld ('VTGWORO_RESID',    (/ 'lev' /), 'A','m s-2', &
          'V tendency - orog. GW drag from rdg-resid')
     call register_vector_field('UTGWORO_RESID', 'VTGWORO_RESID')
  ...
  if (use_gw_movmtn_pbl) then
    ...
    ! Don't use deep convection heating depths below this limit.
     ...
     call addfld ('UTGW_MOVMTN',(/ 'lev' /), 'A','m s-2', &
          'Mov Mtn dragforce - u component')
     call addfld ('VTGW_MOVMTN',(/ 'lev' /), 'A','m s-2', &
