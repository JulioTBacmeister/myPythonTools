...
def main(sstA,ens,year0,year1):
    ...
    basename = BaseName + 'cam.h4.T850.'
    # Directories
    drc='/glade/campaign/cgd/ccr/nanr/HPSS/tokeep/TIMESLICE/atm/proc/tseries/hourly3/T850/'
    ...
    pTime = f"Overall time creating t850-500   {toc_overall - tic_overall:0.4f} seconds"
    print(pTime)
    ...
    npSaveFile = '/glade/work/juliob/NumPySaves/T850Trax/'+BaseName+'-t850trax-'+yAyA+'.npz'
    np.savez( npSaveFile , t850trk=prectrk  )
